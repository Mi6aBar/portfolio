  ...
  return (
    <>
      ...
      >
        ...
        <footer
          id="site-footer"
          className="border-t border-white/10 px-4 sm:px-6 py-3 flex flex-col items-start gap-1.5 sm:flex-row sm:items-center sm:justify-between sm:gap-3 text-[10px] text-white/30 tracking-widest uppercase"
        >
