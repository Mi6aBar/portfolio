    ...
    <section id="hero" className="relative z-0 overflow-visible bg-[#0F0F0F]">
      ...
      <div className="relative flex flex-col md:flex-row md:min-h-[500px] lg:min-h-[440px] overflow-visible">
        ...
        <motion.div
          ...
          className="relative z-10 w-full min-w-0 md:ml-[38%] lg:ml-[36%] flex flex-1 flex-col justify-center overflow-visible px-4 sm:px-6 md:pr-8 lg:pr-12 md:pl-6 py-6 sm:py-8 md:py-10 pb-12 sm:pb-16 md:pb-28 lg:pb-20 text-left"
        >
          ...
          <div className="hero-social-row relative z-40 flex flex-row flex-wrap items-center gap-2 sm:gap-3 w-full min-w-0 pb-1 sm:pb-2">
            <a
              href={TELEGRAM_LINK}
              target="_blank"
            ...
            <a
              href={EMAIL_LINK}
              aria-label="Email"
              className="hero-social-btn hero-social-btn--email text-[10px] sm:text-[11px] uppercase tracking-[0.16em] sm:tracking-[0.2em]"
            >
              <span className="hero-social-btn__glow" aria-hidden="true" />
              <span className="hero-social-btn__inner hero-social-btn__inner--icon">
                <Mail className="w-4 h-4 shrink-0" />
                <span className="hidden lg:inline normal-case tracking-normal">mishabar1997@gmail.com</span>
                <span className="hidden sm:inline lg:hidden">MAIL</span>
              </span>
            </a>
          </div>
        </motion.div>
      ...
      <div
        className="hero-bottom-feather pointer-events-none absolute inset-x-0 bottom-0 h-20 sm:h-28 md:h-52 lg:h-60 z-[5]"
        aria-hidden="true"
      />
    </section>
  );
