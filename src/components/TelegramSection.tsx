...
export function TelegramSection() {
  ...
  return (
    <section
      id="telegram"
      className="relative z-10 overflow-visible py-8 sm:py-10 md:py-12 px-4 sm:px-6 w-full bg-[#0F0F0F] -mt-10 sm:-mt-16 md:-mt-32 pt-14 sm:pt-20 md:pt-28 md:border-b md:border-white/5 scroll-mt-11"
    >
