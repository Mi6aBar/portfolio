...
export function TelegramSection() {
  ...
  return (
    <section
      id="telegram"
      className="telegram-section relative z-10 overflow-visible max-md:py-0 md:py-12 px-4 sm:px-6 w-full bg-[#0F0F0F] md:bg-transparent -mt-10 sm:-mt-16 md:-mt-52 pt-14 sm:pt-20 md:pt-10 max-md:border-b max-md:border-white/5 scroll-mt-11"
    >
